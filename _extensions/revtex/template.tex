...
%
$doc-class.tex()$
%%% PRETEND CAPTION HAS BEEN LOADED
\ProvidesFile{caption.sty}
\ProvidesFile{subcaption.sty}
%%%
%%%% BABEL PATCH (from this stack exchange question: https://tex.stackexchange.com/questions/266336/bibliography-error-with-revtex4-when-language-included-with-book)
